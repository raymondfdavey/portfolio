final Map info = {
  "MPS INTERESTS": {
    ...
    "links": {
      "data scraping jupyter-notebook (github)":
          "https://github.com/raymondfdavey/mp-registered-interests/tree/main/mp_registered_interests_data_preprocessing",
      "deployed frontend (github)":
          "https://github.com/raymondfdavey/reg-interests-flutter-via-node",
      "deployed backend":
          "https://github.com/raymondfdavey/mps-registered-interests-backend"
    },
    "hosted": "azure",
    "github":
        "https://github.com/raymondfdavey/mps-registered-interests-frontend",
    "live": "https://registeredinterests.azurewebsites.net/#/",
    "includes":
  ...
  "NC NEWS": {
    ...
    "links": {
      "front-end": "https://github.com/raymondfdavey/NC-news",
      "backend": "https://github.com/raymondfdavey/be-nc-news"
    },
    "hosted": "heroku",
  ...
  "YRGLSET": {
    ...
    "links": {
      "front-end": "https://github.com/raymondfdavey/yrglset",
      "backend": "https://github.com/raymondfdavey/YRGLSET-FINAL"
    },
  ...
  "WHO'S WHERE": {
    ...
    "stack": "react.js",
    "about":
        "Paired programming assignment for Northcoders bootcamp. includes testing in yarn",
    "links": {
      "front-end": "https://github.com/raymondfdavey/whoswhere",
    },
    "hosted": "GitHub pages",
  ...
  "QUAKE DATA": {
    ...
    "links": {
      "front-end": "https://github.com/raymondfdavey/quaker",
    },
    "hosted": "GitHub pages",
  ...
  "FREE THE BEES!": {
    ...
    "links": {"frontend": "https://github.com/raymondfdavey/bees-in-space"},
    "hosted": "GitHub pages",
  ...
  "SHAME": {
    ...
    "stack": "flutter",
    "about":
        "Simple website for a friends band to practice a different style of site. In progress as they are asking for different bits of functionality",
    "links": {"frontend": "https://github.com/raymondfdavey/shame"},
    "hosted": "GitHub pages",
